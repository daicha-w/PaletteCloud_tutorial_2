class User < ApplicationRecord
  ...
  has_many :following, through: :active_relationships,  source: :followed, class_name: 'User'
  has_many :followers, through: :passive_relationships, source: :follower, class_name: 'User'
